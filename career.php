  ...
  <div id="smooth-wrapper">
    <div id="smooth-content">
      ...
      <main>
          ...
          <div class="container large">
            <div class="page-title-area-inner section-spacing-top">
              <div class="page-title-wrapper">
                <h2 class="page-title fade-anim">Careers</h2>
              </div>
            </div>
          </div>
        </section>
              ...
              <div class="section-header fade-anim">
                <div class="section-title-wrapper">
                  ...
                  <div class="title-wrapper">
                    <h2 class="section-title font-sequelsans-romanbody">Join our team & let’s work together</h2>
                  </div>
                </div>
              </div>
              <div class="services-wrapper-box fade-anim">
                <div class="services-wrapper-2">
                  <a class="fade-anim title-hover " href="service-details.html">
                    <div class="service-box-wrapper ">
                      <div class="service-box d-flex justify-content-between align-items-center ">
                        <div class="number">
                          001
                        </div>
                        <h3 class="title fs-1 ">Business Development Executive</h3>
                        <p class="text">(02 Open Roles )</p>
                        <div class="icon">

                          <i class="fa-solid fa-forward icon-effect"></i>
                        </div>
                  ...
                  <a class="fade-anim title-hover " href="service-details.html">
                    <div class="service-box-wrapper ">
                      <div class="service-box d-flex justify-content-between align-items-center ">
                        ...
                        <h3 class="title fs-1 ">Graphic Designer</h3>
                        <p class="text">(02 Open Roles )</p>
                        <div class="icon">
                  ...
                  <a class="fade-anim title-hover " href="service-details.html">
                    <div class="service-box-wrapper ">
                      <div class="service-box d-flex justify-content-between align-items-center ">
                        ...
                        <h3 class="title fs-1 ">Lead Generation</h3>
                        <p class="text">(02 Open Roles )</p>
                        <div class="icon">
                ...
                <div class="service-content">
                  <div class="section-info-wrapper fade-anim" data-direction="left">
                    <div class="thumb parallax-view">
                      <img src="assets/imgs/gallery/car.jpg" alt="image" data-speed="0.9">
                    </div>
                    <div class="text-wrapper">
                      <p class="text text-invert">What sets us apart is what brings us together – a shared passion for
                        solving business challenges through strategy, design, and engineering. We are the sum total of
                        our team, their unique perspectives, capabilities, and our ability to collaborate from ideation
                        to deployment.</p>
                  ...
                  <div class="section-thumb-wrapper fade-anim" data-delay="0.45" data-direction="right">
                    <div class="thumb parallax-view">
                      <img src="assets/imgs/gallery/car2.jpg" alt="image" data-speed="0.8">
                    </div>
                  </div>
                </div>
              </div>
        ...
        <!-- service area end  -->
        <section class="info-area-page-about py-5 my-5">
          <div class="container large">
             
            <div class="info-area-page-about-inner  row align-items-center">

              <div class="section-header fade-anim col-md-5">
                <div class="">
                 
                  <div class="title-wrapper">
                    <h2 class="section-title font-sequelsans-romanbody">Global Perks & Benefits.</h2>
                  
                  </div>
                  <div class="text-wrapper">
                      <p class="text fs-5">We want you to love working here as much as we do. To inspire our team to be creative, productive, and most importantly – feel valued as employees, we offer endless perks and de-stressors. How fun it is to unwind while at work!</p>

                    </div>
                </div>
              </div>
              <div class="counter-wrapper-box fade-anim col-md-7 ">
                <div class="counter-wrapper-career">
                  <div class="funfact-item">
                    <p class="text">Vacation & Paid Time Off</p>
                    
                  </div>
                  <div class="funfact-item">
                    <p class="text">Work-life Integratione</p>
                    
                  </div>
                  <div class="funfact-item">
                    <p class="text">Maternity/Paternity Benefits</p>
                  </div>
                  <div class="funfact-item">
                    <p class="text">Personal Career Growth</p>
                  </div>
                  <div class="funfact-item">
                    <p class="text">Healthy Food & Snacks</p>
                  </div>
                  <div class="funfact-item">
                    <p class="text">Learning & Development</p>
                  </div>
                </div>
              </div>
            </div>
