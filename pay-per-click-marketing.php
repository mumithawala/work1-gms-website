                                ...
                                <div class="section-content">
                                    <div class="text-wrapper">
                                        <p class="text text-justify">
                                            At Gandhi Media Solutions, we understand the power of Pay-Per-Click (PPC)
                            ...
                            <div class="section-header">
                                <div class="section-title-wrapper">
                                    ...
                                    <div class="title-wrapper fade-anim" data-direction="right">
                                        <h2 class="section-title font-sequelsans-romanbody fs-2">Whether you’re a bold startup or an established industry leader, we’re here to amplify your brand through high-impact Pay-Per-Click campaigns, in-depth keyword research, strategic ad targeting, and continuous optimization for maximum ROI.</h2>
                                    </div>
                                </div>
                            </div>
