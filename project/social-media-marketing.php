...
<head>
    ...
    <title>GMS - Social Media Marketing</title>
                        ...
                        <div class="hero-area-service-details-inner section-spacing-top">
                            ...
                            <div class="section-header fade-anim">
                                <div class="section-title-wrapper">
                                    <div class="title-wrapper">
                                        <h2 class="section-title font-sequelsans-romanbody">Social Media<br>
                                            Marketing</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="section-content-wrapper fade-anim">
                                <div class="section-content">
                                    <div class="text-wrapper">
                                        <p class="text text-justify">
                                            At <b>Gandhi Media Solutions</b>, we understand the power of social media in
                                            shaping brand perception, engaging with audiences, and driving business
                                            growth. With our expertise in Social Media Marketing (SMM), we help
                                            businesses like yours harness the full potential of social platforms to
                                            achieve your marketing objectives and connect with your target audience in
                                            meaningful ways.</p>
                                    </div>
                                ...
                                <div class="section-thumb parallax-view">
                                    <img src="assets/imgs/gallery/smm.jpg" alt="image" data-speed="0.8">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="section-header">
                                <div class="section-title-wrapper">
                                    ...
                                    <div class="title-wrapper fade-anim" data-direction="right">
                                        <h2 class="section-title font-sequelsans-romanbody fs-2">Whether you’re a bold
                                            startup or an established industry leader, we’re here to amplify your brand
                                            through high-impact Pay-Per-Click campaigns, in-depth keyword research,
                                            strategic ad targeting, and continuous optimization for maximum ROI.</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="approach-wrapper-box">
                                ...
                                <div class="approach-wrapper fade-anim" data-direction="right">
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <h3 class="title">Brand Discovery & Audience Research</h3>
                                        <p class="text">
                                            We start by understanding your brand identity, goals, target audience,
                                            competitors,
                                            and existing social presence to uncover key opportunities for growth.
                                        </p>
                                    </div>

                                    <div class="approach-box">
                                        <span class="number">02</span>
                                        <h3 class="title">Content & Campaign Planning</h3>
                                        <p class="text">
                                            Using insights, we develop a data-driven social media strategy including
                                            content themes,
                                            posting schedules, ad creatives, and audience targeting to maximize
                                            engagement.
                                        </p>
                                    </div>
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <h3 class="title">Launch & Active Management</h3>
                                        <p class="text">
                                            We launch campaigns across platforms like Facebook, Instagram, LinkedIn, and
                                            Twitter,
                                            managing posts, ads, and interactions while continuously optimizing
                                            performance.
                                        </p>
                                    </div>
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <h3 class="title">Analytics & Growth Scaling</h3>
                                        <p class="text">
                                            We track metrics like reach, engagement, conversions, and ROI with detailed
                                            analytics,
                                            refining strategies and scaling what works for sustained brand growth.
                                        </p>
                                    </div>
                                ...
                                <div class="features-wrapper">
                                    <div class="feature-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text">We work side-by-side with our clients to build impactful
                                                campaigns that feel truly
                                                collaborative.</p>
                                        </div>
                                    </div>
                                    <div class="feature-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text"> Every decision we make is guided by real data and
                                    ...
                                    <div class="feature-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text"> We design every touchpoint around your audience’s needs to
                                                ensure seamless,
                                    ...
                                    <div class="feature-box">
                                        ...
                                        <div class="content">
                                            ...
                                            <p class="text">Our multidisciplinary team brings creativity, strategy and
                                                technical expertise
                                ...
                                <div class="section-content">
                                    <div class="section-title-wrapper">
                                        <div class="title-wrapper">
                                            <h2 class="section-title font-sequelsans-romanbody">
                                                Climb the ladder to success with our
                                    ...
                                    <div class="values-wrapper">
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Successful social media campaigns executed across Facebook, Instagram,
                                                LinkedIn, Twitter, and more for clients in multiple industries.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Client retention rate thanks to transparent analytics, measurable
                                                engagement growth, and consistent content performance.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Average increase in followers, engagement, and qualified leads by
                                                optimizing content strategy, audience targeting, and ad spend through
                                                data-driven social media tactics.
                                            </p>
                                        </div>
                                    </div>
                                    >
                    ...
                    <div class="container rr-container-1405 ">
                        <div class="project-top heading-space">
                            <div class="section-heading heading-3 mb-0">
                                <h4 class="section-subtitle py-2" data-text-animation="fade-in" data-duration="1.5">
                                    Recent Works Gallery</h4>
                                <h2 class="" data-text-animation data-duration="1">Our
                                    Recent Project Gallery</h2>
                            </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="project-box">
                                                <div class="project-thumb">
                                                    <div class="shape"></div>
                                                    <img src="assets/imgs/gallery/wd.jpg" alt="project">
                                                </div>

                                                <div class="project-content">
                                                    <span>Team Members</span>
                                                    <h3 class="title"><a href="portfolio-details.html">Advertisement
                                                            Design</a></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="project-box">
                                                <div class="project-thumb">
                                                    <div class="shape"></div>
                                                    <img src="assets/imgs/gallery/dm.jpg" alt="project">
                                                </div>

                                                <div class="project-content">
                                                    <span>Team Members</span>
                                                    <h3 class="title"><a href="portfolio-details.html">Web Application
                                                            Design</a></h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="project-box">
                                                ...
                                                <div class="project-content">
                                                    <span>Team Members</span>
                                                    <h3 class="title"><a href="portfolio-details.html">Medical
                                                            Application
                                                            Design</a></h3>
                                                </div>
                                            </div>
                                ...
                                <div class="accordion" id="accordionExample">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show"
                                            ...
                                            <div class="accordion-body">
                                                We provide a full suite of services including SEO, PPC advertising,
                                                social media management,
                                                content marketing,
                                                email marketing, web design, branding and analytics to help you grow
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseTwo" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                We begin with a discovery session to understand your goals, audience and
                                                competitors.
                                                Based on research and data, we create a tailored digital marketing plan
                                                aligned to your
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseThree" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Timelines vary by service. SEO can take 3–6 months to show significant
                                                results, while paid
                                                advertising
                                                can generate leads immediately. We provide regular reports so you can
                                                track progress.
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseFour" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                We combine creative thinking, data-driven strategies and transparent
                                                communication. Our
                                                campaigns are
                                                fully customized and focused on measurable outcomes rather than
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseFive" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Yes, we partner with startups, small businesses and established brands
                                                across different
                                                industries.
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseSix" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                We track KPIs like website traffic, conversion rates, cost per lead,
                                                ROI, and engagement
                                                metrics.
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapseSeven" class="accordion-collapse collapse"
                                            data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                Absolutely. We can act as a full-service partner or an extension of your
                                                existing marketing
                                                team,
