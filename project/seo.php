                            ...
                            <div class="section-header fade-anim">
                                <div class="section-title-wrapper">
                                    <div class="title-wrapper">
                                        <h2 class="section-title font-sequelsans-romanbody">Search Engine Optimization
                                        </h2>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="section-content">
                                    <div class="text-wrapper">
                                        <p class="text text-justify">
                                            At <b>Gandhi Media Solutions</b>, we understand the importance of effective
                                            Search
                                            Engine Optimization (SEO) in driving organic traffic, increasing visibility,
                                            and maximizing your online reach. We specialize in crafting customized SEO
                                            strategies tailored to your unique business objectives, helping you stand
                                            out in the digital crowd and achieve sustainable growth.</p>
                                    </div>
                                    <div class="feature-list">
                                        <ul>
                                            <li> Website Audit & Analyse</li>
                                            <li> Keyword Research & Optimization </li>
                                            <li> On-Page SEO</li>
                                            <li> Images video optimization</li>
                                            <li> Google Analytics</li>
                                            <li> Technical SEO</li>
                                            <li> Content Optimization</li>
                                            <li> Off - Paye SEO (Link building)</li>
                                            <li> Voice search</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="section-thumb parallax-view">
                                    <img src="assets/imgs/gallery/seo.jpg" alt="image" data-speed="0.8">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="section-header">
                                <div class="section-title-wrapper">
                                    ...
                                    <div class="title-wrapper fade-anim" data-direction="right">
                                        <h2 class="section-title font-sequelsans-romanbody fs-2"> End-to-end search
                                            engine optimization solutions that drive visibility and long-term growth.
                                        </h2>
                                    </div>
                                </div>
                            </div>
                            <div class="approach-wrapper-box">
                                ...
                                <div class="approach-wrapper fade-anim" data-direction="right">
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <h3 class="title">SEO Audit & Strategy</h3>
                                        <p class="text">
                                            We start with a full website audit to analyze your current SEO performance,
                                            competitors,
                                            and keyword opportunities, then create a tailored SEO strategy for
                                            measurable growth.
                                        </p>
                                    </div>
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <h3 class="title">On-Page Optimization</h3>
                                        <p class="text">
                                            Our team optimizes meta tags, content, URLs, and internal linking while
                                            improving site speed
                                            and mobile responsiveness to enhance user experience and search visibility.
                                        </p>
                                    </div>

                                    <div class="approach-box">
                                        <span class="number">03</span>
                                        <h3 class="title">Off-Page & Content Marketing</h3>
                                        <p class="text">
                                            We build high-quality backlinks, develop targeted content campaigns, and
                                            leverage social signals
                                            to increase your domain authority and organic reach.
                                        </p>
                                    </div>

                                    <div class="approach-box">
                                        <span class="number">04</span>
                                        <h3 class="title">Tracking & Continuous Improvement</h3>
                                        <p class="text">
                                            We monitor rankings, traffic, and conversions with advanced analytics,
                                            providing transparent reports
                                            and ongoing optimizations to keep your SEO performance climbing.
                                        </p>
                                    </div>
                        ...
                        <div class="value-area-inner section-spacing">
                            <div class="section-content-wrapper fade-anim">
                                ...
                                <div class="section-content">
                                    <div class="section-title-wrapper">
                                        <div class="title-wrapper">
                                            <h2 class="section-title font-sequelsans-romanbody">Chart a course for
                                                growth and navigate
                                                to business prosperity through SEO.</h2>
                                        </div>
                                    </div>
                                    <div class="values-wrapper">
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Successful SEO campaigns delivered across industries, helping businesses
                                                improve rankings, traffic, and online visibility.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Client satisfaction rate achieved through transparent reporting,
                                                measurable results, and customized SEO strategies.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Average increase in organic traffic and qualified leads achieved for our
                                                clients through data-driven SEO optimization.
                                            </p>
                                        </div>
                                    </div>
