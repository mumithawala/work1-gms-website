...
<head>
    ...
    <title>GMS - Website Development</title>
                        ...
                        <div class="hero-area-service-details-inner section-spacing-top">
                            ...
                            <div class="section-header fade-anim">
                                <div class="section-title-wrapper">
                                    <div class="title-wrapper">
                                        <h2 class="section-title font-sequelsans-romanbody">Website <br>
                                            Development</h2>
                                    </div>
                                </div>
                            </div>
                            <div class="section-content-wrapper fade-anim">
                                <div class="section-content">
                                    <div class="text-wrapper">
                                        <p class="text text-justify">
                                            At <b>Gandhi Media Solutions</b>, Internet website developers are
                                            professionals who
                                            specialize in designing, creating,and maintaining websites for individuals
                                            businesses, organizations, and other entities.These developers typically
                                            possess a combination of technical skills, creativity, and problem-solving
                                            abilities to produce functional and visually appealing websites.</p>
                                    </div>
                                ...
                                <div class="section-thumb parallax-view">
                                    <img src="assets/imgs/gallery/wd.jpg" alt="image" data-speed="0.8">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="section-title-wrapper">
                                    ...
                                    <div class="title-wrapper fade-anim" data-direction="right">
                                        <h2 class="section-title font-sequelsans-romanbody fs-2">Whether you’re a bold
                                            startup or an
                                            established industry leader, we’re here to amplify your brand through
                                ...
                                <div class="approach-wrapper fade-anim" data-direction="right">
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <p class="text">
                                            ...
                                            then create a clear project roadmap for your website.
                                        </p>
                                    </div>

                                    <div class="approach-box">
                                        <span class="number">02</span>
                                        <h3 class="title">Design & Prototyping</h3>
                                        <p class="text">
                                            Our team crafts wireframes and visual mockups focusing on user experience,
                                            responsive layouts, and your brand identity before development begins.
                                        </p>
                                    </div>
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <p class="text">
                                            We build your website using modern technologies, clean code and SEO-friendly
                                            structure,
                                            integrating required features like CMS, e-commerce, or APIs.
                                        </p>
                                    </div>
                                    ...
                                    <div class="approach-box">
                                        ...
                                        <p class="text">
                                            We rigorously test across devices and browsers, ensure performance and
                                            security,
                                            then launch your site with analytics and ongoing support options.
                                        </p>
                                    </div>
                        ...
                        <div class="value-area-inner section-spacing">
                            <div class="section-content-wrapper fade-anim">
                                ...
                                <div class="section-content">
                                    <div class="section-title-wrapper">
                                        <div class="title-wrapper">
                                            <h2 class="section-title font-sequelsans-romanbody">Set sail for growth,
                                                unlock success
                                                with our website development
                                                prowess!</h2>
                                        </div>
                                    </div>
                                    <div class="values-wrapper">
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Custom websites designed and developed for startups, SMEs and large
                                                enterprises across a wide range of industries.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Client satisfaction rate thanks to our transparent process,
                                                pixel-perfect design, and scalable, secure code.
                                            </p>
                                        </div>
                                        ...
                                        <div class="value-box">
                                            ...
                                            <p class="text">
                                                Average improvement in site speed and performance after our redesigns,
                                                boosting SEO rankings and user experience.
                                            </p>
                                        </div>
                                    </div>
