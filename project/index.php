...
<body class="body-wrapper dark body-digital-agency font-heading-instrumentsans-medium">
              ...
              <div class="hero-content section-spacing-bottom">
                ...
                <div class="section-content">
                    ...
                    <div class="features-wrapper">
                      <div class="feature-box">
                        <div class="content">
                          ...
                          <p class="text">Average clients satisfied
                            and repeating</p>
                        </div>
                      </div>
                      <div class="feature-box">
                  ...
                  <div class="text-wrapper fade-anim" data-delay="0.75">
                    <p class="text">We’re a digital products design & development agency that works passionately
                      with the digital experiences.</p>
                  </div>
                </div>
              </div>
            ...
            <div class="about-area-inner section-spacing">
              <div class="section-content">
                ...
                <div class="text-wrapper">
                  <p class="text text-justify">We offer a wide range of IT Services to our customers,
                    including product development, digital marketing,
                    UI/UX designing, performance marketing and more. Our experienced team is
                    dedicated to helping you optimize your IT solutions and maximize your business success</p>
                </div>
                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>Web Development
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>Social Media Marketing
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>Google Ads
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>SEO services
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>Ecommerce Development
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>UI/UX Designing
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>YouTube Marketing
                      </h2>
                    </div>
                  </div>
                  <div class="swiper-slide">
                    <div class="text-slider-item">
                      <h2 class="title"><span class="dot"></span>Performance Marketing
                      </h2>
                    </div>
                  </div>
                </div>
              ...
              <div class="services-wrapper-box">
                <div class="services-wrapper-1">
                  <div class="service-box fade-anim">
                    ...
                    <div class="thumb">
                      <img class="grow" src="assets/imgs/gallery/branding.jpg " alt="image">
                    </div>
                  </div>
                  <div class="service-box fade-anim">
                    <div class="count">
                    ...
                    <div class="content">
                      <h3 class="title"><a href="service-details.html">Campaign Management</a></h3>
                      <ul class="service-list">
                        <li><a href="service-details.html">Google Ads</a></li>
                        <li><a href="service-details.html">Meta Ads</a></li>
                    ...
                    <div class="thumb">
                      <img class="grow" src="assets/imgs/gallery/cm.jpg" alt="image">
                    </div>
                  </div>
                  <div class="service-box fade-anim">
                    <div class="count">
                    ...
                    <div class="content">
                      <h3 class="title"><a href="website-development.php">Development</a></h3>
                      <ul class="service-list">
                        <li><a href="website-development.php">WordPress</a></li>
                        <li><a href="website-development.php">Webflow</a></li>
                    ...
                    <div class="thumb">
                      <img class="grow" src="assets/imgs/gallery/dev.jpg" alt="image">
                    </div>
                  </div>
                  <div class="service-box fade-anim">
                    <div class="count">
                    ...
                    <div class="content">
                      <h3 class="title"><a href="digital-marketing.php">Digital Marketing</a></h3>
                      <ul class="service-list">
                        <li><a href="digital-marketing.php">Online Marketing</a></li>
                        <li><a href="digital-marketing.php">SEO-Marketing</a></li>
                        <li><a href="digital-marketing.php">Strategy</a></li>
                        <li><a href="digital-marketing.php">Market Research</a></li>
                        <li><a href="digital-marketing.php">Social Media Marketing</a></li>
                        <!-- youtube marketing -->
                        <li><a href="digital-marketing.php">YouTube Marketing</a></li>
                      </ul>
                    </div>
                    <div class="thumb">
                      <img class="grow" src="assets/imgs/gallery/dg.jpg" alt="image">
                    </div>
                  </div>
                </div>
              </div>
  ...
  <div class="modal fade" id="workModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content" style="width: var(-webkit-fill-available);">
